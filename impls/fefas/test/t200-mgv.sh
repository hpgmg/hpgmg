...
test_expect_stdout 'FE Poisson MG V-cycle solve fedegree=1 serial' 1 'fefas mgv -op_type poisson1 -M 16,20,24 -L 1,1,1 -smooth 1,1 -mg_eig_target 2,0.2' '
...
test_expect_stdout 'FE Poisson MG V-cycle solve fedegree=1 parallel' 4 'fefas mgv -op_type poisson1 -M 16,20,24 -L 1,1,1 -p 1,2,2 -cmax 240 -smooth 1,1 -mg_eig_target 2,0.2' '
