...
test_expect_stdout 'FE Poisson fedegree=1 serial' 1 'fefas test-opapply -op_type poisson1 -M 4,8,12 -L 1,1,1' '
...
test_expect_stdout 'FE Poisson fedegree=1 serial refined' 1 'fefas test-opapply -op_type poisson1 -M 8,16,24 -L 1,1,1' '
...
test_expect_stdout 'FE Poisson fedegree=1 parallel refined' 4 'fefas test-opapply -op_type poisson1 -M 8,16,24 -L 1,1,1 -p 1,2,2' '
