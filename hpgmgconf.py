...
def main():
    ...
    fe.add_argument('--fe', action='store_false', dest='fe', help='Do not build the Finite-Element solver',default=True)
    fv = parser.add_argument_group('Finite Volume options')
    fv.add_argument('--fv', action='store_true', dest='fv', help='Do not build the Finite-Volume solver',default=True)
