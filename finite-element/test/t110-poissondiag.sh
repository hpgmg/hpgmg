...
test_expect_stdout 'FE Poisson diagonal fedegree=1 serial' 1 'fefas test-opdiagonal -op_type poisson1 -M 8,12,16 -L 1,1,1' '
...
test_expect_stdout 'FE Poisson diagonal fedegree=1 parallel' 4 'fefas test-opdiagonal -op_type poisson1 -M 8,12,16 -L 1,1,1 -p 2,1,2' '
